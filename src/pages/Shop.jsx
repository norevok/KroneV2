...
const PRODUCTS = [
  {
    ...
    de_desc: 'Ein unvergesslicher Restaurantabend im Kulinarium by Ammesso — mediterrane Küche, Wein aus der Region, Kerzenschein.',
    en_desc: 'An unforgettable dinner at Kulinarium by Ammesso — Mediterranean cuisine, regional wine, candlelight.',
  ...
  },
  {
    ...
    emoji: '✨',
    amount: 149,
    de_title: 'Genussaufenthalt',
    en_title: 'Gourmet Stay',
    de_desc: 'Eine Übernachtung im Boutique-Hotel Krone Langenburg inkl. Frühstück & einem Abendessen im Kulinarium. Der beliebteste Gutschein.',
  ...
  {
    id: 'voucher_wochenende',
    emoji: '🌿',
    amount: 249,
    de_title: 'Romantisches Wochenende',
    en_title: 'Romantic Weekend',
    de_desc: 'Zwei Nächte im historischen Herzen Langenburgs — mit Frühstück, mehrgängigem Dinner und einem Glas Sekt zur Begrüßung.',
  ...
  },
  {
    ...
    emoji: '👑',
    amount: 349,
    de_title: 'King Suite Erlebnis',
    en_title: 'King Suite Experience',
    de_desc: 'Übernachtung in unserer exklusiven King Suite, privates Dinner mit Degustationsmenü, Champagner & Langenburg-Panorama.',
...
export default function Shop() {
  ...
  return (
    <div className="min-h-screen bg-ivory text-charcoal pb-24 lg:pb-10">
      ...
      {/* Hero */}
      <div className="relative bg-espresso page-top pb-14 sm:pb-20 px-5 overflow-hidden">
